"""
Django settings for courserank project.
...
from courserank.secret_keys.project_secret_key import SECRET_KEY
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'courserank/static')
]
