...
class Udemy(object):
    ...
    def course_detail(self, id, **kwargs):
        '''
        ...
        '''
        course = requests.get(self._get_url('courses/{}'.format(id), **kwargs), auth=self._authentication).json()
        return course
